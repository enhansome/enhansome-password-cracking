...
* If in doubt, use [awesome-lint](https://github.com/sindresorhus/awesome-lint) ⭐ 828 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-05
...
* [hcxtools](https://github.com/ZerBea/hcxtools) ⭐ 2,446 | 🐛 1 | 🌐 C | 📅 2026-08-15 - Portable solution for conversion of cap/pcap/pcapng (gz compressed) WiFi dump files to hashcat formats.
* [7z2hashcat](https://github.com/philsmd/7z2hashcat) ⭐ 445 | 🐛 5 | 🌐 Perl | 📅 2026-09-20 - Extract information from password-protected .7z archives (and .sfx files) such that you can crack these "hashes" with hashcat.
...
* [MacinHash](https://github.com/jmagers/MacinHash) ⭐ 39 | 🐛 0 | 🌐 Python | 📅 2018-12-03 - Convert macOS plist password file to hash file for password crackers.
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 26,814 | 🐛 321 | 🌐 C | 📅 2026-09-20 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*

* [hashcat-utils](https://github.com/hashcat/hashcat-utils/) ⭐ 1,623 | 🐛 20 | 🌐 C | 📅 2025-11-08 - Small utilities that are useful in advanced password cracking.
...
* [hate\_crack](https://github.com/trustedsec/hate_crack) ⭐ 1,856 | 🐛 10 | 🌐 Python | 📅 2026-09-19 - A tool for automating cracking methodologies through Hashcat from the TrustedSec team.
...
* [Hashtopolis](https://github.com/hashtopolis/server) ⭐ 1,811 | 🐛 218 | 🌐 PHP | 📅 2026-09-18 - A multi-platform client-server tool for distributing hashcat tasks to multiple computers.
...
*[John the Ripper](https://github.com/openwall/john) ⭐ 13,652 | 🐛 515 | 🌐 C | 📅 2026-08-01 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*
...
* [CUPP](https://github.com/Mebus/cupp) ⭐ 6,545 | 🐛 54 | 🌐 Python | 📅 2026-07-17 - A tool that lets you generate wordlists by user profiling data such as birthday, nickname, address, name of a pet or relative etc.
* [StringZilla](https://github.com/ashvardanian/StringZilla) ⭐ 3,558 | 🐛 30 | 🌐 C | 📅 2026-09-20 - Fastest string sort, search, split, and shuffle for long strings and multi-gigabyte files in Python and C.
...
* [anew](https://github.com/tomnomnom/anew) ⭐ 1,664 | 🐛 8 | 🌐 Go | 📅 2024-01-12 - Append lines from stdin to a file, but only if they don't already appear in the file. Outputs new lines to stdout too, making it a bit like a tee -a that removes duplicates.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 327 | 🐛 5 | 📅 2026-09-20 - This project aim to provide french word list about everything a person could use as a base password.
...
* [bkcrack](https://github.com/kimci86/bkcrack) ⭐ 2,197 | 🐛 20 | 🌐 C++ | 📅 2026-08-09 - Crack legacy zip encryption with Biham and Kocher's known plaintext attack.
