...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 1,076 | 🐛 0 | 📅 2026-07-22 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 1,076 | 🐛 0 | 📅 2026-07-22
* If in doubt, use [awesome-lint](https://github.com/sindresorhus/awesome-lint) ⭐ 820 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-05
...
* [Penglab](https://github.com/mxrch/penglab) ⭐ 976 | 🐛 9 | 🌐 Jupyter Notebook | 📅 2023-07-17 - Abuse of Google Colab for cracking hashes.
...
* [hcxtools](https://github.com/ZerBea/hcxtools) ⭐ 2,436 | 🐛 1 | 🌐 C | 📅 2026-08-15 - Portable solution for conversion of cap/pcap/pcapng (gz compressed) WiFi dump files to hashcat formats.
* [7z2hashcat](https://github.com/philsmd/7z2hashcat) ⭐ 444 | 🐛 5 | 🌐 Perl | 📅 2024-06-15 - Extract information from password-protected .7z archives (and .sfx files) such that you can crack these "hashes" with hashcat.
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 26,715 | 🐛 352 | 🌐 C | 📅 2026-09-06 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*

* [hashcat-utils](https://github.com/hashcat/hashcat-utils/) ⭐ 1,618 | 🐛 21 | 🌐 C | 📅 2025-11-08 - Small utilities that are useful in advanced password cracking.
...
* [Autocrack](https://github.com/pry0cc/autocrack) ⭐ 44 | 🐛 3 | 🌐 Shell | 📅 2023-03-16 - A set of client and server tools for automatically, and lightly automatically cracking hashes.
...
* [hate\_crack](https://github.com/trustedsec/hate_crack) ⭐ 1,857 | 🐛 2 | 🌐 Python | 📅 2026-09-02 - A tool for automating cracking methodologies through Hashcat from the TrustedSec team.
* [Naive hashcat](https://github.com/brannondorsey/naive-hashcat) ⭐ 1,418 | 🐛 12 | 🌐 C | 📅 2022-01-10 - Naive hashcat is a plug-and-play script that is pre-configured with naive, emperically-tested, "good enough" parameters/attack types.
...
* [Hashtopolis](https://github.com/hashtopolis/server) ⭐ 1,806 | 🐛 208 | 🌐 PHP | 📅 2026-09-05 - A multi-platform client-server tool for distributing hashcat tasks to multiple computers.
...
* [fitcrack](https://github.com/nesfit/fitcrack) ⭐ 174 | 🐛 29 | 🌐 C | 📅 2026-04-19 - A hashcat-based distributed password cracking system.
...
* [OneRuleToRuleThemStill](https://github.com/stealthsploit/OneRuleToRuleThemStill) ⭐ 658 | 🐛 0 | 📅 2024-10-16 - "A revamped and updated version of my original OneRuleToRuleThemAll hashcat rule."
* [nsa-rules](https://github.com/NSAKEY/nsa-rules) ⭐ 571 | 🐛 0 | 🌐 Shell | 📅 2017-01-03 - Password cracking rules and masks for hashcat generated from cracked passwords.
...
* [hashcat rules collection](https://github.com/narkopolo/hashcat-rules-collection) ⭐ 169 | 🐛 0 | 📅 2026-01-16 - Probably the largest collection of hashcat rules out there.
...
* [Hashview](https://github.com/hashview/hashview) ⭐ 397 | 🐛 65 | 🌐 Python | 📅 2026-09-06 - A web front-end for password cracking and analytics.
...
* [WebHashCat](https://github.com/hegusung/WebHashcat) ⭐ 325 | 🐛 13 | 🌐 JavaScript | 📅 2026-04-04 - WebHashcat is a very simple but efficient web interface for hashcat password cracking tool.
...
* [hashpass](https://github.com/dj-zombie/hashpass) ⭐ 48 | 🐛 1 | 🌐 Vue | 📅 2022-07-20 - Hash cracking WebApp & Server for hashcat.

## John the Ripper

*[John the Ripper](https://github.com/openwall/john) ⭐ 13,598 | 🐛 514 | 🌐 C | 📅 2026-08-01 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*

* [BitCracker](https://github.com/e-ago/bitcracker) ⭐ 969 | 🐛 57 | 🌐 C | 📅 2024-05-31 - BitCracker is the first open source password cracking tool for memory units encrypted with BitLocker.
* [johnny](https://github.com/openwall/johnny) ⭐ 643 | 🐛 21 | 🌐 C++ | 📅 2023-09-29 - GUI frontend to John the Ripper.

## Misc

* [Name That Hash](https://github.com/HashPals/Name-That-Hash) ⭐ 1,667 | 🐛 7 | 🌐 Python | 📅 2025-12-19 - Don't know what type of hash it is? Name That Hash will name that hash type! Identify MD5, SHA256 and 300+ other hashes. Comes with a neat web app.
* [hashgen](https://github.com/cyclone-github/hashgen) ⭐ 41 | 🐛 0 | 🌐 Go | 📅 2026-08-19 - Hashgen is a simple yet very fast CLI hash generator written in Go and cross compiled for Linux, Windows & Mac.
* [Hashes](https://github.com/zefr0x/hashes) ⭐ 29 | 🐛 1 | 🌐 Python | 📅 2026-06-12 - Identify hashing algorithms (GUI frontend for Name That Hash).
...
* [PACK](https://github.com/iphelix/pack) ⭐ 893 | 🐛 11 | 🌐 Python | 📅 2019-12-10 - A collection of utilities developed to aid in analysis of password lists in order to enhance password cracking through pattern detection of masks, rules, character-sets and other password characteristics.
* [Pipal](https://github.com/digininja/pipal) ⭐ 664 | 🐛 8 | 🌐 Ruby | 📅 2023-08-27 - THE password analyser.
* [pcfg\_cracker](https://github.com/lakiw/pcfg_cracker) ⭐ 371 | 🐛 14 | 🌐 Python | 📅 2025-09-02 - This project uses machine learning to identify password creation habits of users.
* [Graphcat](https://github.com/Orange-Cyberdefense/graphcat) ⭐ 167 | 🐛 3 | 🌐 Python | 📅 2023-02-17 - Generate graphs and charts based on password cracking result.
...
* [CUPP](https://github.com/Mebus/cupp) ⭐ 6,512 | 🐛 54 | 🌐 Python | 📅 2026-07-17 - A tool that lets you generate wordlists by user profiling data such as birthday, nickname, address, name of a pet or relative etc.
* [StringZilla](https://github.com/ashvardanian/StringZilla) ⭐ 3,551 | 🐛 29 | 🌐 C | 📅 2026-09-02 - Fastest string sort, search, split, and shuffle for long strings and multi-gigabyte files in Python and C.
* [Mentalist](https://github.com/sc0tfree/mentalist) ⭐ 2,024 | 🐛 11 | 🌐 Python | 📅 2026-04-14 - Mentalist is a graphical tool for custom wordlist generation. It utilizes common human paradigms for constructing passwords and can output the full wordlist as well as rules compatible with Hashcat and John the Ripper.
* [anew](https://github.com/tomnomnom/anew) ⭐ 1,658 | 🐛 8 | 🌐 Go | 📅 2024-01-12 - Append lines from stdin to a file, but only if they don't already appear in the file. Outputs new lines to stdout too, making it a bit like a tee -a that removes duplicates.
* [bopscrk](https://github.com/r3nt0n/bopscrk) ⭐ 1,119 | 🐛 6 | 🌐 Python | 📅 2024-09-07 - Generate smart and powerful wordlists for targeted attacks. Includes song lyrics fetching and different transforms.
...
* [Elpscrk](https://github.com/D4Vinci/elpscrk) ⭐ 952 | 🐛 3 | 🌐 Python | 📅 2024-10-14 - Elpscrk is like cupp, but it's based on permutations and statistics while being memory efficient.
* [kwprocessor](https://github.com/hashcat/kwprocessor) ⭐ 611 | 🐛 7 | 🌐 C | 📅 2025-08-19 - Advanced keyboard-walk generator with configureable basechars, keymap and routes.
* [maskprocessor](https://github.com/hashcat/maskprocessor/) ⭐ 509 | 🐛 14 | 🌐 C | 📅 2022-06-20 - High-performance word generator with a per-position configureable charset.
* [princeprocessor](https://github.com/hashcat/princeprocessor) ⭐ 502 | 🐛 9 | 🌐 C | 📅 2023-10-30 - Standalone password candidate generator using the PRINCE algorithm.
...
* [statsprocessor](https://github.com/hashcat/statsprocessor/) ⭐ 199 | 🐛 1 | 🌐 C | 📅 2023-10-27 - Word generator based on per-position markov-chains.
* [TTPassGen](https://github.com/tp7309/TTPassGen) ⭐ 169 | 🐛 0 | 🌐 Python | 📅 2026-09-01 - Flexible and scriptable password dictionary generator which supportss brute-force, combination, complex rule modes etc.
...
* [Rling](https://github.com/Cynosureprime/rling) ⭐ 101 | 🐛 0 | 🌐 C | 📅 2026-08-29 - RLI Next Gen (Rling), a faster multi-threaded, feature rich alternative to rli found in hashcat utilities.
* [common-substr](https://github.com/sensepost/common-substr) ⭐ 67 | 🐛 0 | 🌐 Go | 📅 2026-06-03 - Simple tool to extract the most common substrings from an input text. Built for password cracking.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 327 | 🐛 5 | 📅 2026-09-06 - This project aim to provide french word list about everything a person could use as a base password.
...
* [RockYou2021](https://github.com/ohmybahgosh/RockYou2021.txt) ⭐ 1,013 | 🐛 4 | 📅 2024-03-10 -  RockYou2021.txt is a MASSIVE WORDLIST compiled of various other wordlists.
...
* [pdfrip](https://github.com/mufeedvh/pdfrip) ⭐ 1,408 | 🐛 17 | 🌐 Rust | 📅 2026-03-26 - A multi-threaded PDF password cracking utility equipped with commonly encountered password format builders and dictionary attacks.
...
* [bkcrack](https://github.com/kimci86/bkcrack) ⭐ 2,186 | 🐛 20 | 🌐 C++ | 📅 2026-08-09 - Crack legacy zip encryption with Biham and Kocher's known plaintext attack.
...
* [PassGPT](https://github.com/javirandor/passgpt) ⭐ 100 | 🐛 3 | 🌐 Python | 📅 2025-03-13 - PassGPT is a GPT-2 model trained from scratch on password leaks.
* [RNN-Passwords](https://github.com/gehaxelt/RNN-Passwords) ⭐ 87 | 🐛 0 | 📅 2021-03-28 - Using the char-rnn to learn and guess passwords.
* [adams](https://github.com/TheAdamProject/adams) ⭐ 23 | 🐛 2 | 🌐 C | 📅 2024-05-07 - Reducing Bias in Modeling Real-world Password Strength via Deep Learning and Dynamic Dictionaries.
