...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 1,055 | 🐛 0 | 📅 2026-07-22 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 1,055 | 🐛 0 | 📅 2026-07-22
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 26,576 | 🐛 367 | 🌐 C | 📅 2026-08-19 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*
...
* [hate\_crack](https://github.com/trustedsec/hate_crack) ⭐ 1,854 | 🐛 10 | 🌐 Python | 📅 2026-08-18 - A tool for automating cracking methodologies through Hashcat from the TrustedSec team.
...
* [Hashtopolis](https://github.com/hashtopolis/server) ⭐ 1,800 | 🐛 216 | 🌐 PHP | 📅 2026-08-18 - A multi-platform client-server tool for distributing hashcat tasks to multiple computers.
...
* [Kaonashi](https://github.com/kaonashi-passwords/Kaonashi) ⭐ 1,098 | 🐛 1 | 📅 2022-04-22 - Wordlist, rules and masks from Kaonashi project (RootedCON 2019).
...
* [Hashview](https://github.com/hashview/hashview) ⭐ 397 | 🐛 85 | 🌐 Python | 📅 2026-08-17 - A web front-end for password cracking and analytics.
...
*[John the Ripper](https://github.com/openwall/john) ⭐ 13,512 | 🐛 512 | 🌐 C | 📅 2026-08-01 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*
...
* [statsprocessor](https://github.com/hashcat/statsprocessor/) ⭐ 196 | 🐛 1 | 🌐 C | 📅 2023-10-27 - Word generator based on per-position markov-chains.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 327 | 🐛 5 | 📅 2026-08-19 - This project aim to provide french word list about everything a person could use as a base password.
...
* [pdfrip](https://github.com/mufeedvh/pdfrip) ⭐ 1,403 | 🐛 17 | 🌐 Rust | 📅 2026-03-26 - A multi-threaded PDF password cracking utility equipped with commonly encountered password format builders and dictionary attacks.
