...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 1,078 | 🐛 0 | 📅 2026-09-06 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 1,078 | 🐛 0 | 📅 2026-09-06
* If in doubt, use [awesome-lint](https://github.com/sindresorhus/awesome-lint) ⭐ 821 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-05
...
* [Cloud\_crack](https://github.com/lordsaibat/Cloud_crack) ⭐ 48 | 🐛 0 | 🌐 HCL | 📅 2019-03-20 - Crack passwords using Terraform and AWS.
...
* [hcxtools](https://github.com/ZerBea/hcxtools) ⭐ 2,437 | 🐛 1 | 🌐 C | 📅 2026-08-15 - Portable solution for conversion of cap/pcap/pcapng (gz compressed) WiFi dump files to hashcat formats.
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 26,745 | 🐛 348 | 🌐 C | 📅 2026-09-10 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*
...
* [hate\_crack](https://github.com/trustedsec/hate_crack) ⭐ 1,857 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - A tool for automating cracking methodologies through Hashcat from the TrustedSec team.
...
* [Hashtopolis](https://github.com/hashtopolis/server) ⭐ 1,807 | 🐛 209 | 🌐 PHP | 📅 2026-09-10 - A multi-platform client-server tool for distributing hashcat tasks to multiple computers.
...
* [hashcat rules collection](https://github.com/narkopolo/hashcat-rules-collection) ⭐ 170 | 🐛 0 | 📅 2026-01-16 - Probably the largest collection of hashcat rules out there.
...
* [Hashview](https://github.com/hashview/hashview) ⭐ 397 | 🐛 61 | 🌐 Python | 📅 2026-09-10 - A web front-end for password cracking and analytics.
...
*[John the Ripper](https://github.com/openwall/john) ⭐ 13,612 | 🐛 515 | 🌐 C | 📅 2026-08-01 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*
...
* [hashgen](https://github.com/cyclone-github/hashgen) ⭐ 42 | 🐛 0 | 🌐 Go | 📅 2026-09-07 - Hashgen is a simple yet very fast CLI hash generator written in Go and cross compiled for Linux, Windows & Mac.
...
* [CUPP](https://github.com/Mebus/cupp) ⭐ 6,523 | 🐛 54 | 🌐 Python | 📅 2026-07-17 - A tool that lets you generate wordlists by user profiling data such as birthday, nickname, address, name of a pet or relative etc.
* [StringZilla](https://github.com/ashvardanian/StringZilla) ⭐ 3,554 | 🐛 29 | 🌐 C | 📅 2026-09-07 - Fastest string sort, search, split, and shuffle for long strings and multi-gigabyte files in Python and C.
...
* [anew](https://github.com/tomnomnom/anew) ⭐ 1,660 | 🐛 8 | 🌐 Go | 📅 2024-01-12 - Append lines from stdin to a file, but only if they don't already appear in the file. Outputs new lines to stdout too, making it a bit like a tee -a that removes duplicates.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 327 | 🐛 5 | 📅 2026-09-10 - This project aim to provide french word list about everything a person could use as a base password.
...
* [PassGPT](https://github.com/javirandor/passgpt) ⭐ 101 | 🐛 3 | 🌐 Python | 📅 2025-03-13 - PassGPT is a GPT-2 model trained from scratch on password leaks.
