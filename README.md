...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 1,065 | 🐛 0 | 📅 2026-07-22 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 1,065 | 🐛 0 | 📅 2026-07-22
...
* [itunes\_backup2hashcat](https://github.com/philsmd/itunes_backup2hashcat) ⭐ 122 | 🐛 0 | 🌐 Perl | 📅 2017-02-04 - Extract the information needed from the Manifest.plist files to convert it to hashes compatible with hashcat.
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 26,652 | 🐛 354 | 🌐 C | 📅 2026-08-29 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*

* [hashcat-utils](https://github.com/hashcat/hashcat-utils/) ⭐ 1,610 | 🐛 21 | 🌐 C | 📅 2025-11-08 - Small utilities that are useful in advanced password cracking.
...
* [hate\_crack](https://github.com/trustedsec/hate_crack) ⭐ 1,855 | 🐛 7 | 🌐 Python | 📅 2026-08-27 - A tool for automating cracking methodologies through Hashcat from the TrustedSec team.
...
*[John the Ripper](https://github.com/openwall/john) ⭐ 13,563 | 🐛 513 | 🌐 C | 📅 2026-08-01 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*
...
* [StringZilla](https://github.com/ashvardanian/StringZilla) ⭐ 3,543 | 🐛 29 | 🌐 C | 📅 2026-08-20 - Fastest string sort, search, split, and shuffle for long strings and multi-gigabyte files in Python and C.
...
* [anew](https://github.com/tomnomnom/anew) ⭐ 1,657 | 🐛 9 | 🌐 Go | 📅 2024-01-12 - Append lines from stdin to a file, but only if they don't already appear in the file. Outputs new lines to stdout too, making it a bit like a tee -a that removes duplicates.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 327 | 🐛 5 | 📅 2026-08-29 - This project aim to provide french word list about everything a person could use as a base password.
...
* [bkcrack](https://github.com/kimci86/bkcrack) ⭐ 2,178 | 🐛 20 | 🌐 C++ | 📅 2026-08-09 - Crack legacy zip encryption with Biham and Kocher's known plaintext attack.
