...
Read [CONTRIBUTING.md](https://github.com/narkopolo/awesome-password-cracking/blob/main/CONTRIBUTING.md) ⭐ 1,088 | 🐛 0 | 📅 2026-09-06 before contributing! In short:

* If you think an item shouldn't be here [open an issue](https://github.com/narkopolo/awesome-password-cracking/issues/new) ⭐ 1,088 | 🐛 0 | 📅 2026-09-06
...
*[Hashcat](https://github.com/hashcat/hashcat) ⭐ 26,832 | 🐛 317 | 🌐 C | 📅 2026-09-22 is the "World's fastest and most advanced password recovery utility." The following are projects directly related to Hashcat in one way or another.*

* [hashcat-utils](https://github.com/hashcat/hashcat-utils/) ⭐ 1,624 | 🐛 20 | 🌐 C | 📅 2025-11-08 - Small utilities that are useful in advanced password cracking.
...
* [hate\_crack](https://github.com/trustedsec/hate_crack) ⭐ 1,857 | 🐛 7 | 🌐 Python | 📅 2026-09-21 - A tool for automating cracking methodologies through Hashcat from the TrustedSec team.
...
* [autocrack](https://github.com/timbo05sec/autocrack) ⭐ 130 | 🐛 0 | 🌐 Python | 📅 2018-04-16 - Hashcat wrapper to help automate the cracking process.

### Distributed cracking

* [Hashtopolis](https://github.com/hashtopolis/server) ⭐ 1,811 | 🐛 216 | 🌐 PHP | 📅 2026-09-22 - A multi-platform client-server tool for distributing hashcat tasks to multiple computers.
...
* [OneRuleToRuleThemAll](https://github.com/NotSoSecure/password_cracking_rules) ⭐ 1,634 | 🐛 7 | 📅 2021-12-09 - "One rule to crack all passwords. or atleast we hope so."
...
* [OneRuleToRuleThemStill](https://github.com/stealthsploit/OneRuleToRuleThemStill) ⭐ 662 | 🐛 0 | 📅 2024-10-16 - "A revamped and updated version of my original OneRuleToRuleThemAll hashcat rule."
...
* [Hashview](https://github.com/hashview/hashview) ⭐ 399 | 🐛 50 | 🌐 Python | 📅 2026-09-22 - A web front-end for password cracking and analytics.
...
* [hashpass](https://github.com/dj-zombie/hashpass) ⭐ 49 | 🐛 1 | 🌐 Vue | 📅 2022-07-20 - Hash cracking WebApp & Server for hashcat.

## John the Ripper

*[John the Ripper](https://github.com/openwall/john) ⭐ 13,665 | 🐛 519 | 🌐 C | 📅 2026-08-01 is "an Open Source password security auditing and password recovery tool available for many operating systems." The following are projects directly related to John the Ripper in one way or another.*
...
* [CUPP](https://github.com/Mebus/cupp) ⭐ 6,547 | 🐛 54 | 🌐 Python | 📅 2026-07-17 - A tool that lets you generate wordlists by user profiling data such as birthday, nickname, address, name of a pet or relative etc.
* [StringZilla](https://github.com/ashvardanian/StringZilla) ⭐ 3,559 | 🐛 31 | 🌐 C | 📅 2026-09-22 - Fastest string sort, search, split, and shuffle for long strings and multi-gigabyte files in Python and C.
...
* [French Wordlists](https://github.com/clem9669/wordlists) ⭐ 327 | 🐛 5 | 📅 2026-09-22 - This project aim to provide french word list about everything a person could use as a base password.
...
* [bkcrack](https://github.com/kimci86/bkcrack) ⭐ 2,202 | 🐛 20 | 🌐 C++ | 📅 2026-08-09 - Crack legacy zip encryption with Biham and Kocher's known plaintext attack.
